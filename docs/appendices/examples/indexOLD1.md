...
| Auto-populate alias | Property Derivation | [Alias Generator](property-derivation.md#auto-generate-member-alias) |
| Sync to Planning | Dimension Mapping | [HFM to Planning](dimension-mapping.md#hfm-to-planning-synchronization) |
| Approval notifications | Workflow Task | [Email on Approval](workflow-tasks.md#email-notification-on-approval) |
| Audit member creation | Hierarchy Action | [Creation Audit](hierarchy-actions.md#audit-trail-for-member-creation) |
...
- Review [Getting Started](../../getting-started/index.md) for basics
- Check [API Reference](../../api/index.md) for available functions
