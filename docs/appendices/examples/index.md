...
### [Property Derivation](property-derivation)
...
### [Hierarchy Actions](hierarchy-actions)
...
|----------|------------|---------|
| Validate email format | Property Validation | [Email Validator](property-validation#email-validation) |
| Auto-populate alias | Property Derivation | [Alias Generator](property-derivation#auto-generate-member-alias) |
| Sync to Planning | Dimension Mapping | [HFM to Planning](dimension-mapping#hfm-to-planning-synchronization) |
| Approval notifications | Workflow Task | [Email on Approval](workflow-tasks#email-notification-on-approval) |
| Audit member creation | Hierarchy Action | [Creation Audit](hierarchy-actions#audit-trail-for-member-creation) |
...
- See [Debugging Guide](../debugging) for troubleshooting
