# 🔽**Post Hierarchy Action Input Parameters**

## Input Parameters

The following table lists Input Parameters that are available for Post Hierarchy Action Logic Scripts.
...
- [Post Hierarchy Action Output Parameters](output-parameters.md)
- [Post Hierarchy Action Examples](examples.md)
