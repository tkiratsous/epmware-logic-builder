# 🔽**Property Mapping Input Parameters**

## Input Parameters

The following table lists Input Parameters that are available for Property Mapping Logic Scripts.
...
| g_mapped_prop_label | Mapped Property Label |
| g_dim_class_name | Dimension Class Name |
| g_prop_name | Property Name (Source application) |
| g_prop_label | Property Label (Source application) |
| g_prop_value | Property Value (Source application) |
...
- [Property Mapping Output Parameters](output-parameters.md)
