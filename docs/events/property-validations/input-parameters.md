# 🔽**Property Validation Input Parameters**

## Input Parameters

The following table lists Input Parameters that are available for Property Validation Logic Scripts.
...
- [Property Validation Output Parameters](output-parameters.md)
- [Property Validation Examples](examples.md)
